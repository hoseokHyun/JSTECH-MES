    ...
    <div id="quality-cmm-dashboard" className="space-y-4 pb-12 select-none">
      ...
      <div className="bg-white dark:bg-slate-900 p-4 sm:p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-3.5">
          <div className="p-3 rounded-2xl bg-[#00A396] text-white shadow-sm shrink-0">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs bg-teal-100 dark:bg-teal-950/60 text-teal-800 dark:text-teal-300 font-extrabold px-2.5 py-0.5 rounded-full border border-teal-200 dark:border-teal-800">
                IQC · IPQC (CMM) · OQC (COA)
              </span>
            </div>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
              원자재 수입검사(IQC), 공정중 3D 정밀측정(IPQC/CMM), 통계적 공정관리(SPC) 및 최종 출하성적서(COA) 관리
            </p>
          </div>
        </div>
      </div>
